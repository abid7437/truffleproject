...
export default function Pricing2() {
    ...
    return (
        <>
            <section className="pricing-area-two" id="Pricing">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="pricing-item-two wow fadeInLeft" data-wow-delay=".2s">
                                    ...
                                    <div className="pricing-btn">
                                        <Link href="/login" className="btn btn-three">choose plan</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6">
                                <div className="pricing-item-two active wow fadeInUp" data-wow-delay=".4s">
                                    ...
                                    <div className="pricing-btn">
                                        <Link href="/login" className="gradient-btn gradient-btn-three">choose plan</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6">
